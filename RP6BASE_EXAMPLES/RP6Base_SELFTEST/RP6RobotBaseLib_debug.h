...
#define TRIG_ARMED 1
#define TRIGGERED 2
#define TRIG_PROCESS_DATA 3

extern volatile uint16_t ENCL_buffer_values[60];
extern volatile uint16_t ENCL_buffer_time[60];
extern volatile uint8_t ENCL_trig;
extern volatile uint16_t ENCL_k;
extern volatile uint16_t ENCL_time;

extern volatile uint16_t ENCR_buffer_values[60];
extern volatile uint16_t ENCR_buffer_time[60];
extern volatile uint8_t ENCR_trig;
extern volatile uint16_t ENCR_k;
extern volatile uint16_t ENCR_time;
